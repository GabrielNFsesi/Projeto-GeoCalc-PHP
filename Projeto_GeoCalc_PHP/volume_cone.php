...
<body>
    ...
    <p><strong>Fórmula: </strong>volume = (π x raio² x altura) / 3</p>
    <form action="volume_cone.php" method="POST">
 ...
 echo "Para um cone com um raio de <strong>{$raio} cm</strong> e uma altura de <strong>{$altura} cm</strong>:<br>";
